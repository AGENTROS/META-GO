class BiometricRiskEngine:
    ...
    """
    def __init__(self, face_weight=0.35, voice_weight=0.30, liveness_weight=0.20, accuracy_weight=0.15):
    ...
    def calculate_trust_score(self, 
                              ...
                              voice_spoof_risk_score: float) -> tuple[float, str, dict]:
        """
        ...
        if f_live < 45.0: # High probability of face liveness check failure (printed photo/screen)
