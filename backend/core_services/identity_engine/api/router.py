...
from core_services.identity_graph_engine.services.graph_service import IdentityGraphService
from core_services.identity_graph_engine.repositories.graph_repo import MongoGraphRepository
...
async def link_wallet(body: WalletLinkRequest, request: Request):
    ...
    try:
        await wallet_service.link_wallet(body.did, body.wallet_address, body.chain, body.signature)
