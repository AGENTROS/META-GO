...
def test_end_to_end_ocr_upload_pipeline(mock_publish):
    ...
    mock_publish.assert_any_call("Credential.Uploaded", {"filename": "test_aadhaar.jpg", "type": "Aadhaar"})
...
def test_end_to_end_credential_issuance(mock_publish, mock_insert):
    ...
    mock_publish.assert_any_call("Credential.Verified", {"id": cred["id"], "owner": "did:metago:0x123"})
    mock_publish.assert_any_call("Credential.Issued", {"id": cred["id"], "type": "Aadhaar"})
